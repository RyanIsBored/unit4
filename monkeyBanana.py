...
#increase score and displat new text at bottom of screen
def updateScore():
    data['score'] += 10
...
#keep track of how many frames have happened and moves banana if it has been more than 300 frames since last move
def step():
    data['frames'] += 1
    if data['frames'] == 300:
        moveBanana()
